...
export const DAILY_QUESTS: QuestDefinition[] = [
  ...
  {
  id: "daily_kill_10",
  title: "Latihan Tempur",
  description: "Kalahkan 10 monster. Cocok untuk pemula.",
  type: "daily",
  category: "combat",
  icon: "🗡️",
  objective: { type: "kill_monsters", target: 10 },
  rewards: { gold: 80, exp: 50 },
  },
  {
  id: "daily_kill_25",
  title: "Pejuang Muda",
  description: "Kalahkan 25 monster hari ini.",
  type: "daily",
  category: "combat",
  icon: "⚔️",
  objective: { type: "kill_monsters", target: 25 },
  rewards: { gold: 150, exp: 100 },
  },
  {
  id: "daily_earn_200",
  title: "Pengumpul Harta",
  description: "Kumpulkan 200 Gold dari monster.",
  type: "daily",
  category: "general",
  icon: "💰",
  objective: { type: "earn_gold", target: 200 },
